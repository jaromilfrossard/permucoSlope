...
#' @param slope_FUN A function that will be used to compute the slope of the response variables. \code{slope_spline}, \code{slope_locpol} and \code{slope_diff} are available.
